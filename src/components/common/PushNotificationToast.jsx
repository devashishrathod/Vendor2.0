...
export default function PushNotificationToast({ toast, onDismiss, duration = 6000 }) {
  ...
  return (
    <>
      ...
      >
        <span
          className="shrink-0 mt-0.5 w-8 h-8 rounded-full bg-emerald-500/20 flex items-center justify-center"
        ...
        <div className="flex-1 min-w-0">
          ...
          {toast.body && (
            <p className="text-[12.5px] text-emerald-100/80 mt-1 leading-snug break-words">
              {toast.body}
            </p>
          )}
        </div>
