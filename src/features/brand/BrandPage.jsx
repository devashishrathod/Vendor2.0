...
const BrandPage = ({ brandId: brandIdProp }) => {
  ...
  if (!brandId) {
    return (
      <div className="min-h-screen bg-white dark:bg-gray-900 px-6 py-8 md:px-10">
      ...
      <div className="min-h-screen bg-white dark:bg-gray-900 px-6 py-8 md:px-10">
        <div className="mx-auto max-w-6xl">
          <div className="bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700 rounded-2xl shadow-sm p-6">
            ...
            <button
              onClick={reload}
              className="mt-3 inline-flex items-center rounded-xl border border-gray-200 dark:border-gray-700 px-4 py-2 text-sm font-semibold text-gray-600 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors"
            >
              Try again
            </button>
          </div>
