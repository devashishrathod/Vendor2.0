        ...
        return (
          <div
            ...
            className={`flex flex-wrap items-center gap-4 px-5 py-4 ${
              idx !== DAYS.length - 1 ? "border-b border-gray-50 dark:border-gray-700" : ""
            }`}
          >
            ...
            {dayData.isOpen ? (
              <div className="flex flex-1 flex-wrap items-center gap-3">
                <input
                  ...
                  className="rounded-xl border border-gray-200 dark:border-gray-700 px-3.5 py-2 text-sm text-gray-700 dark:bg-gray-800 dark:text-gray-100 outline-none transition-colors focus:border-emerald-500 focus:ring-2 focus:ring-emerald-100"
                />
