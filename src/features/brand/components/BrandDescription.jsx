      ...
      <div className="flex items-center justify-between mb-5">
        <div className="flex items-center gap-3">
          ...
          <div className="flex-1">
            <h2 className="text-sm font-bold text-gray-900 dark:text-gray-100 leading-tight">Brand Description</h2>
      ...
      {isEditing ? (
        <div>
          <textarea
            ...
            rows={5}
            className="w-full rounded-xl border border-gray-200 dark:border-gray-700 p-3.5 text-sm text-gray-700 dark:bg-gray-800 dark:text-gray-100 outline-none transition-colors placeholder:text-gray-400 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-100"
          ...
          <div className="mt-3 flex gap-3">
            ...
            <button
              ...
              className="px-4 py-2 text-sm border border-gray-200 dark:border-gray-700 text-gray-600 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 rounded-xl font-semibold"
            >
              Cancel
            </button>
          </div>
        ...
        <>
          <p className="text-sm text-gray-600 dark:text-gray-300 whitespace-pre-wrap pl-12">
