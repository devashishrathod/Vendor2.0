      ...
      {isEditing ? (
        <div>
          <textarea
            ...
            rows={5}
            className="w-full rounded-xl p-3.5 text-sm text-gray-700 bg-emerald-50 dark:bg-emerald-500/10 dark:text-gray-100 outline-none transition-colors placeholder:text-gray-400 focus:ring-2 focus:ring-emerald-100"
          ...
          <div className="mt-3 flex gap-3">
            ...
            <button
              ...
              className="px-4 py-2 text-sm text-gray-600 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 rounded-xl font-semibold"
            >
              Cancel
            </button>
          </div>
