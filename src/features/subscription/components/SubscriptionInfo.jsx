...
export default function SubscriptionInfo({ subscription }) {
  ...
  const items = [
    ...
    { icon: <Gift className="w-4 h-4" />, iconBg: 'bg-emerald-50 dark:bg-emerald-500/10', iconText: 'text-emerald-500 dark:text-emerald-400', label: 'Discount Percentage', value: getDiscountPercentageLabel(originalPrice, discountedPrice) },
    { icon: <CreditCard className="w-4 h-4" />, iconBg: 'bg-emerald-50 dark:bg-emerald-500/10', iconText: 'text-emerald-500 dark:text-emerald-400', label: 'Paid Amount', value: formatCurrencyINR(paidAmount) },
  ];
