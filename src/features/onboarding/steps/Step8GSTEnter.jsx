...
//       </div>
//       <button onClick={onDismiss} aria-label="Dismiss" className="text-emerald-400 hover:text-emerald-600 transition-colors flex-shrink-0">
...
//           <span className="font-mono font-bold">{panUpper}</span>. Characters 3–12 of GSTIN must match your PAN exactly.
//         </p>
//       </div>
//     </div>
//   );
...
// // ── Main Component ───────────────────────────────────────────────────
// // onComplete → called after success toast, hands navigation back to OnboardingPage
// //              so completeAndGo() runs: markComplete + advanceScreen + goToStep
// export default function Step8GSTEnter({ pan: panProp = "", onComplete }) {
//   // Fallback: pull PAN from store if parent didn't pass prop
//   const panFromStore = useOnboardingStore(
//     (s) => s.formData?.panDetails?.data?.pan || s.formData?.panDetails?.pan || ""
//   );
//   const pan = panProp || panFromStore;
...
//       // ✅ onComplete call karo — navigation OnboardingPage handle karega
//       // completeAndGo → markComplete + advanceScreen + goToStep(GST_READONLY)
//       setTimeout(() => {
//         onComplete?.();
//       }, 1500);
//     } catch (err) {
...
//         </div>
//         <div>
//           <h2 className="text-lg font-extrabold text-gray-900 leading-tight tracking-tight">Enter your GST Number</h2>
//           <p className="text-xs text-gray-400 mt-0.5">Please enter your 15-digit GSTIN to continue</p>
//         </div>
//         {pan && (
//           <div className="ml-auto flex items-center gap-1.5 bg-blue-50 border border-blue-100 rounded-full px-3 py-1.5 flex-shrink-0">
//             <svg className="w-3 h-3 text-blue-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
//               <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}
//                 d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
//             </svg>
//             <span className="text-[10px] text-blue-400 font-semibold">PAN:</span>
//             <span className="text-[10px] text-blue-700 font-mono font-bold tracking-widest">{pan.toUpperCase()}</span>
//           </div>
//         )}
//       </div>
...
//                     </div>
//                   ) : (
//                     <div className={`w-5 h-5 rounded-full flex items-center justify-center ${hasPANMismatch ? "bg-orange-400" : "bg-red-400"}`}>
//                       <svg className="w-3 h-3 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
//                         <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={3} d="M6 18L18 6M6 6l12 12" />
//                       </svg>
//                     </div>
...
//                   {isValid ? "All validations passed. Ready to fetch details." : "Fix the errors on the right to continue."}
//                 </p>
//               </div>
//             </div>
//           )}
...
//       {/* ── Tips ── */}
//       <div className="bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 mb-4 step-in" style={{ animationDelay: "0.1s" }}>
...
//         </p>
//         <div className="grid grid-cols-2 gap-x-4 gap-y-1.5">
//           {["GSTIN is case-insensitive", "First 2 digits are your state code", "Characters 3–12 must match your PAN"].map((tip, i) => (
//             <div key={i} className="flex items-start gap-1.5">
//               <span className="w-1 h-1 rounded-full bg-slate-400 flex-shrink-0 mt-1.5" />
