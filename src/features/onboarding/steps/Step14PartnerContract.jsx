      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2">
          ...
          <div className="p-7 flex flex-col gap-5 border-b md:border-b-0 md:border-r border-gray-100 dark:border-gray-700">
            ...
            <div className="bg-gray-50 dark:bg-gray-700/40 border border-gray-100 dark:border-gray-700 rounded-xl p-4">
            ...
            <label className={`flex items-start gap-3 p-4 rounded-xl border-2 transition-all duration-200
              ${locked
                ...
                : `cursor-pointer border-gray-100 dark:border-gray-700 hover:border-emerald-200 hover:bg-emerald-50/40 ${agreed ? "border-emerald-300 bg-emerald-50/60" : ""}`
              }`}
            >
              <input
                type="checkbox"
              ...
              <button
                ...
                className={`w-full py-3 rounded-xl font-bold text-sm tracking-wide
                  ...
                  ${!locked && agreed && !loading
                    ...
                    : "bg-gray-100 dark:bg-gray-700 text-gray-400 border border-gray-200 dark:border-gray-700 cursor-not-allowed"
                  }`}
              >
                {locked ? (
