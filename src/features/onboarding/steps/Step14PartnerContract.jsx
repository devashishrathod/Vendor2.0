    ...
    >
      ...
      >
        ...
        <div className="bg-emerald-50 border-b border-emerald-100 px-6 py-4 flex items-start gap-3">
          ...
          <button
            onClick={onClose}
            className="w-7 h-7 rounded-lg bg-emerald-100 hover:bg-emerald-200 flex items-center justify-center transition-colors flex-shrink-0"
          >
            <svg
        ...
        <div className="grid grid-cols-2 divide-x divide-gray-100">
          ...
          <div className="px-6 py-5 flex flex-col gap-4">
            ...
            <div className="flex items-start gap-2 bg-amber-50 border border-amber-100 rounded-xl px-3 py-2.5 mt-auto">
              ...
              <p className="text-[11px] text-amber-700 leading-relaxed">
                Your contact details will be used for subscription confirmation
                and billing updates.
              </p>
            </div>
          </div>
          ...
          <div className="px-6 py-5 flex flex-col gap-3">
            ...
            <div className="flex flex-col gap-1.5">
              ...
              {previewUrl && (
                <div
                  className="relative rounded-xl overflow-hidden border border-emerald-200 bg-emerald-50/30"
                  style={{ height: "140px" }}
                >
                  <img
                    src={previewUrl}
              ...
              {!uploadFile && (
                <label
                  className={`relative flex flex-col items-center justify-center gap-2 px-4 py-6 rounded-xl
                ...
                >
                  ...
                  <div className="text-center">
                    <p className="text-xs font-semibold text-gray-600 group-hover:text-emerald-600 transition-colors">
                      Click to upload
                    </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2">
          ...
          <div className="p-7 bg-gray-50/50 flex flex-col gap-4">
            ...
            <div className="mt-auto pt-4 border-t border-gray-100">
              <p className="text-xs text-gray-400 leading-relaxed">
                For the full legal document, open the partner agreement link.
                Contact{" "}
                <a
                  href="mailto:support@trydood.com"
