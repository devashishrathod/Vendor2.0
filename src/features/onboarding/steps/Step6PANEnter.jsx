...
export default function Step6PANEnter({ onFetchSuccess, onComplete }) {
  ...
  const ruleLabels = [
    ...
    "Must be a valid business PAN",
  ];
  const rules = PAN_RULES.map((r, index) => ({
    ...
    <div className="max-w-5xl mx-auto">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-[0_1px_3px_rgba(0,0,0,0.04)] p-4 sm:p-5">
        ...
        <div className="flex items-center gap-4 mb-4 step-in">
          ...
          <div>
            <h2 className="text-lg font-extrabold text-gray-900 dark:text-gray-100 leading-tight tracking-tight">
              Verify Your Business PAN
            </h2>
            <p className="text-xs text-gray-500 mt-0.5">
              Enter your business PAN to verify your registered business details.
            </p>
          </div>
        </div>
        ...
        >
          ...
          <div className="flex flex-col gap-3">
            <div className="flex flex-col">
              ...
              <div className="relative">
                ...
                onBlur={() => {
                  if (pan) setTouched(true);
                }}
                maxLength={10}
                className={`w-full px-4 py-3 pr-10 bg-white rounded-xl text-sm font-mono font-semibold
            ...
            <div
              ...
              ${isValid ? "bg-emerald-50" : "bg-red-50/60"}`}
            >
              <div
          ...
          <div className="bg-gray-50/80 dark:bg-gray-700/40 rounded-xl px-4 py-4 flex flex-col justify-center">
        ...
        >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-4 gap-y-1.5">
            {[
              "Enter the PAN linked to your business.",
              "Make sure it matches your registration details.",
              "Use 10 characters with no spaces or special characters.",
            ].map((tip, i) => (
          ...
          <div className="flex-1 min-w-0 order-2 sm:order-1">
            ...
            {upper.trim() ? (
              ...
              <p className="text-[11px] text-gray-300 pl-1">
                Your verified PAN details will appear here.
              </p>
            )}
          </div>
