      ...
      <div className="flex-1 min-w-0 pr-3">
        ...
        {isEditing ? (
          <Select
            ...
            className="bg-emerald-100 dark:bg-emerald-500/20 text-gray-800"
          />
        ) : (
...
export default function BankDetailsReview({ accountType, onNavigate, lastStep, lastSubStep }) {
  ...
  return (
    <div className="w-full max-w-md mx-auto" style={{ fontFamily: "'Inter','Segoe UI',sans-serif" }}>
      ...
      {/* Rows */}
      <div className="w-full bg-white dark:bg-gray-800 px-4 divide-y divide-gray-100 dark:divide-gray-700 rounded-xl">
