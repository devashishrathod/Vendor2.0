...
const BUSINESS_TYPES = [
  {
    ...
    icon: (active) => (
      <svg
        className={`w-6 h-6 transition-colors ${active ? "text-emerald-600" : "text-gray-400"}`}
        fill="none"
        viewBox="0 0 24 24"
        stroke="currentColor"
      >
...
function TypeCard({ type, selected, onClick }) {
  ...
  return (
    ...
    >
      ...
      {type.badge && (
        <span
          className={`text-[10px] font-semibold px-2.5 py-0.5 rounded-full transition-colors duration-200
    ...
    <div className="flex items-center justify-center p-4">
      ...
      <div className="w-full max-w-3xl">
        ...
        <div className="text-center mb-7">
          <div
            className="w-11 h-11 rounded-2xl bg-emerald-50 border border-emerald-100
        ...
        {/* Selected summary */}
        <div
          className={`mb-4 transition-all duration-300 overflow-hidden ${selected ? "max-h-14 opacity-100" : "max-h-0 opacity-0"}`}
        >
