...
function DetailRow({ label, value }) {
  ...
  return (
    <div className="flex items-center justify-between py-2.5 border-b border-gray-100 last:border-0">
      ...
      <span className="text-xs font-semibold text-gray-800 text-right max-w-[60%]">
        {value}
      </span>
    </div>
  );
  ...
  return (
    <>
      ...
      >
        ...
        {/* PAN Card */}
        <div
          className="bg-gradient-to-r from-emerald-500 to-emerald-600 rounded-2xl px-5 py-4 mb-4
        ...
        >
          <div>
            ...
            <p className="text-white text-xl font-mono font-bold tracking-[0.2em]">
              {d.pan}
            </p>
          </div>
