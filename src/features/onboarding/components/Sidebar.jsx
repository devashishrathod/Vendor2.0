...
const LockCircle = () => (
  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" className="flex-shrink-0">
    ...
    <rect x="8" y="11" width="8" height="6" rx="1" fill="none" stroke="#c4c9d4" strokeWidth="1.5"/>
    <path d="M9.5 11V9a2.5 2.5 0 0 1 5 0v2" stroke="#c4c9d4" strokeWidth="1.5" strokeLinecap="round"/>
  </svg>
);
    ...
    >
      ...
      <div className="flex pb-4 pt-1 px-2.5">
        ...
        <div className="relative flex-shrink-0" style={{ width: 8 }}>
          {/* gray base */}
          <div className="absolute inset-x-0 top-[14px] bottom-[14px] bg-gray-200" style={{ borderRadius: 2 }} />
          {/* green fill up to active step */}
          {(() => {
            const activeIdx = SIDEBAR_STEPS.findIndex(s => s.id === currentStep);
            const pct = activeIdx <= 0 ? 0 : (activeIdx / (SIDEBAR_STEPS.length - 1)) * 100;
            return (
              <div
            ...
            return (
              <button
                ...
                className={`flex items-center gap-2.5 w-full text-left
                  ...
                  ${isActive  ? 'bg-emerald-50 cursor-pointer'
