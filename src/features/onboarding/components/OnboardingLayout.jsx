  ...
  return (
    <header className="lg:hidden sticky top-0 z-30 flex items-center justify-between
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          <p className="text-xs font-extrabold text-gray-900 dark:text-gray-100 leading-tight">{title}</p>
...
export default function OnboardingLayout({
  ...
  return (
    <div
      className="h-screen bg-white dark:bg-gray-800 relative overflow-hidden flex flex-col lg:flex-row"
      ...
      <div className="relative flex flex-col flex-1 min-w-0 min-h-0 h-screen" style={{ zIndex: 1 }}>
        ...
        <header className="hidden lg:flex px-8 py-2 items-center justify-between
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-sm font-bold text-gray-900 dark:text-gray-100 leading-tight">Vendor Onboarding</h1>
