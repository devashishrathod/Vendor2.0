      ...
      <div className="max-w-2xl mx-auto px-6 py-8">
        ...
        <div className="bg-amber-50 border border-amber-200 rounded-xl px-4 py-3.5 mb-5">
          ...
          <p className="text-xs text-amber-700 leading-relaxed">
            Trydood will review your listing details and verify them soon. If there are any errors,
            your submission will be put on hold. The Trydood team will contact you shortly.
          </p>
        </div>
        ...
        <div className="bg-white border border-gray-100 rounded-xl overflow-hidden">
          ...
          <div className="flex items-center gap-4 px-5 py-4">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-xs text-gray-400 mt-0.5">
                Merchant Token: A4FGNU3DUN0D &nbsp;·&nbsp; Created on: February 25 | 03:14
              </p>
            </div>
          ...
          >
            <svg className="w-4 h-4 group-hover:rotate-45 transition-transform duration-200"
