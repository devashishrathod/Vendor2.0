    ...
    <div>
      ...
      <div className="space-y-5">
        {albums.map((album) => {
          ...
          return (
            <div key={album.id} className="border border-gray-200 dark:border-gray-700 rounded-xl p-4 bg-white dark:bg-gray-800">
              <div className="flex items-start justify-between gap-3 mb-1">
                <input
                  ...
                  className="text-sm font-bold text-gray-900 dark:text-gray-100 border-b border-transparent hover:border-gray-200 dark:hover:border-gray-700 focus:border-emerald-400 outline-none bg-transparent px-0.5 py-0.5 flex-1 disabled:opacity-50"
                />
                <button
              ...
              {itemCount > 0 && (
                <div className="flex flex-wrap gap-3">
                  {album.media.map((m) => (
                    <div key={m.id} className="relative w-20 rounded-lg overflow-hidden border border-gray-200 dark:border-gray-700 group">
                      ...
                      {monthly && (
                        <>
                          <select
                            ...
                            className="w-full text-[10px] border-t border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-600 dark:text-gray-300 outline-none px-0.5 py-0.5"
                          >
                          ...
                          {m.month && (
                            <span className="block text-center text-[9px] font-semibold text-emerald-600 bg-emerald-50 border-t border-gray-200 dark:border-gray-700 py-0.5 truncate">
                              {m.month} Month Photo
                            </span>
                          )}
                        </>
