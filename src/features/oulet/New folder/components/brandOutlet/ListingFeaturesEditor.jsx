              ...
              >
                ...
                <div className="min-w-0 flex-1">
                  <div className="flex items-center gap-2">
                    <span className="text-sm font-semibold text-gray-800 dark:text-gray-100 truncate">{feature.title}</span>
                    {!feature.isActive && (
                ...
                <button
                  ...
                  className="shrink-0 w-5 h-5 flex items-center justify-center rounded-full bg-gray-200 dark:bg-gray-700 hover:bg-red-500 hover:text-white text-gray-600 dark:text-gray-300 text-xs leading-none transition-colors"
                >
                  ×
                </button>
              </div>
