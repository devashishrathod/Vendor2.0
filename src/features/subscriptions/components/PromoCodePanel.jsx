        ...
        <div className="mt-3">
          <div className="flex gap-2">
            <input
              ...
              className="flex-1 text-sm bg-emerald-50 dark:bg-emerald-500/10 dark:text-gray-100 rounded-lg px-4 py-2.5 outline-none focus:ring-2 focus:ring-teal-400 transition"
            />
            <button
              onClick={handleApply}
              disabled={applying}
