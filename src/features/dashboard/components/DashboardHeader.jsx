    ...
    <nav className="bg-white/85 dark:bg-gray-900/85 backdrop-blur-md border-b border-gray-100 dark:border-gray-700 sticky top-0 z-50 relative">
      <div className="px-4 sm:px-6 h-16 flex items-center">
        ...
        <div className="flex items-center gap-4 flex-1">
          ...
          <div className="relative w-9 h-9 rounded-lg overflow-hidden flex-shrink-0 bg-white ring-1 ring-gray-100 dark:ring-gray-700">
            <img
              src={logo}
              alt=""
              className="absolute"
          ...
          <div className="leading-tight hidden sm:block">
            <p className="text-sm font-bold text-gray-900 dark:text-gray-100 tracking-tight">Trydood</p>
          ...
          {NAV_TABS.map(({ label, to }) => (
            <NavLink
              ...
              className={({ isActive }) =>
                ...
                ${isActive
                  ? "text-emerald-600 dark:text-emerald-400 font-semibold bg-white dark:bg-gray-700 shadow-sm"
        ...
        <div className="flex items-center gap-2 flex-1 justify-end">
            ...
            >
              ...
              <div className="flex items-center gap-3 px-4 py-3.5 bg-gradient-to-br from-emerald-50/70 dark:from-emerald-500/10 to-white dark:to-gray-800 border-b border-gray-100 dark:border-gray-700">
                ...
                <div className="min-w-0">
                  <p className="text-sm font-bold text-gray-900 dark:text-gray-100 truncate capitalize">{brand?.brandName || "Your Brand"}</p>
              ...
              <div className="p-1.5 flex flex-col gap-0.5">
                ...
                <NavLink to="/account-information" onClick={() => setProfileOpen(false)}
                  className={({ isActive }) =>
                    ...
                    ${isActive ? "bg-emerald-50 dark:bg-emerald-500/10 text-emerald-700 dark:text-emerald-400" : "text-gray-600 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 hover:text-gray-900 dark:hover:text-gray-100"}`
                  }
                >
                  <span className="w-7 h-7 rounded-lg bg-emerald-50 dark:bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 flex items-center justify-center flex-shrink-0">
                ...
                <button
                  ...
                  className="flex items-center gap-2.5 px-2.5 py-2 rounded-xl text-sm font-medium text-gray-600 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 hover:text-gray-900 dark:hover:text-gray-100 transition-colors duration-150"
                >
                  <span className="w-7 h-7 rounded-lg bg-emerald-50 dark:bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 flex items-center justify-center flex-shrink-0">
                    <svg width="15" height="15" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                      <path strokeLinecap="round" strokeLinejoin="round"
              ...
              <div className="p-1.5">
                <button
                  ...
                  className="w-full flex items-center gap-2.5 px-2.5 py-2 rounded-xl text-sm font-medium text-red-500 hover:bg-red-50 dark:hover:bg-red-500/10 transition-colors duration-150"
                >
                  <span className="w-7 h-7 rounded-lg bg-red-50 dark:bg-red-500/10 text-red-500 flex items-center justify-center flex-shrink-0">
                    <svg width="15" height="15" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                      <path strokeLinecap="round" strokeLinejoin="round"
          ...
          <button
            ...
            className="lg:hidden relative flex items-center justify-center w-9 h-9 rounded-xl
              text-gray-500 dark:text-gray-400 hover:text-emerald-600 dark:hover:text-emerald-400 hover:bg-emerald-50 dark:hover:bg-emerald-500/10 transition-colors duration-150"
          >
